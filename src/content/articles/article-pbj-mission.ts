...
export const articlePbjMission: Article = {
  id: 'article-pbj-mission',
  title: 'Flower Brigade Plans Historic PB&J Mission',
  lead: 'Town volunteers organize a flower and sandwich remembrance caravan.',
  body: [
    {
    ...
    {
      text: 'The caravan set off shortly after noon, accompanied by a wagon of extra napkins and a small marching band that only knew three songs but played them with great enthusiasm. Neighbors waved from driveways as volunteers handed out blossoms and sandwiches with equal care. By evening, the brigade declared the mission a success, promising to make it an annual tradition—though next year they may add juice boxes for improved emotional hydration.',
    },
  ],
}
