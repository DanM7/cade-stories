...
export const articleShoeSafety: Article = {
  id: 'article-shoe-safety',
  title: 'Local Safety Board Warns of Aggressive Footwear',
  lead: 'Safety officials issue guidance after reports of dangerous clawed shoes.',
  body: [
    {
    ...
    {
      text: 'In response, the Safety Board has launched a full investigation, which includes interviewing shoe store employees, monitoring suspicious footwear behavior, and consulting the Department of Imagination Wildlife for cross‑species claw analysis. Until further notice, residents are encouraged to store their shoes in well‑lit areas, avoid stepping into anything that wiggles, and report any footwear attempting unsolicited hugs.',
    },
  ],
}
