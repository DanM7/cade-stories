...
export const articleIceAgePatrol: Article = {
  id: 'article-ice-age-patrol',
  title: 'Teen Grandpa Logger Credited With Ice Age Tiger Patrol',
  lead: 'Archive records place a teenage Grandpa Logger on Ice Age tiger duty.',
  body: [
    {
    ...
    {
      text: 'The Imagination Bureau plans to release more archival material in the coming weeks, including sketches of Grandpa Logger’s patrol routes and a rumored training manual titled “So You’ve Spotted a Saber Tooth Tiger: Now What?” Officials hope the findings will inspire future generations to pursue bold, historically impossible careers. Meanwhile, Cade maintains that Grandpa Logger’s Ice Age service is “just one chapter” in a life story that continues to defy every known rule of geology, biology, and time.',
    },
  ],
}
