...
export const articlePasswordAlert: Article = {
  id: 'article-password-alert',
  title: 'Cyber Unit Flags 41 Muffin Lane as Top Secret Password',
  lead: 'Security teams identify 41 Muffin Lane as a high-risk shared password.',
  body: [
    {
    ...
    {
      text: `Authorities are now urging residents to update their credentials to something less predictable, such as a string of random emojis or the exact number of basements Grandpa Logger owns. Meanwhile, the Cyber Unit is preparing a full audit of other compromised phrases, including “CornIceCream123” and “SaberToothScout.” Until then, officials recommend avoiding any vaults labeled with baked‑good‑related addresses, no matter how delicious they sound.`,
    },
  ],
}
