...
export const articleUppercaseTooth: Article = {
  id: 'article-uppercase-tooth',
  title: 'Dental Desk Opens Investigation Into Uppercase Tooth Pain',
  lead: 'Alphabet dental specialists investigate a new category of uppercase tooth pain.',
  body: [
    {
    ...
    {
      text: 'In response, the Dental Desk has launched a full investigation, which includes reviewing alphabet anatomy, interviewing pediatric patients, and consulting the Department of Imaginary Health for cross‑letter diagnostics. Until more data is available, officials recommend that residents monitor any unusual sensations in their A‑through‑Z regions and report symptoms such as boldness, italics, or unexpected capitalization.',
    },
  ],
}
